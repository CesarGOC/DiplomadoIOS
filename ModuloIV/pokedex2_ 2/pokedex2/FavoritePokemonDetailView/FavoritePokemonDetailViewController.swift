...
class FavoritePokemonDetailViewController: UIViewController {
    ...
    private func setupView() {
        ...
        var selfieButonConfiguration = UIButton.Configuration.plain()
        selfieButonConfiguration.title = "Take selfie"
        
        let selfieButton = UIButton(configuration: selfieButonConfiguration)
