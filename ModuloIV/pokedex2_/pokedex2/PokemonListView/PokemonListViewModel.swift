...
class PokemonListViewModel {
    ...
    var favoritePokemonList: Set<Pokemon> = []
    ...
    private func saveFavoritePokemon(){
        ...
        do{
            ...
            let jasonFavoritePokemon = String(data: favoritePokemonData, encoding: .utf8)
            try jasonFavoritePokemon?.write(to: fileURL, atomically: true, encoding: .utf8)
        }catch{
...
//        saveFavoritePokemon()
        delegate?.shouldReloadTableData()
//        favoritePokemonList.append(favoritePokemon)
    }
}
